...
void OpenGLModelData::init(
	const vec2* vertLocs_, const vec2* UVs_, size_t numVerts_, const uvec3* elems_, size_t numElems_)
{
	numVerts = numVerts_;
	numElems = numElems_;
...
bool OpenGLModelData::isInitialized() { return bisInitialized; }
