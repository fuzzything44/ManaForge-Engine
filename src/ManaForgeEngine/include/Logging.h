	...
	std::basic_ostream<char_t, traits>& stream, severity_t sev)
{
	switch (sev)
	{
	case severity_t::Trace: stream << "Trace"; break;
	case severity_t::Debug: stream << "Debug"; break;
	case severity_t::Info: stream << "Info"; break;
	case severity_t::Warning: stream << "Warning"; break;
	case severity_t::Error: stream << "Error"; break;
	case severity_t::Fatal: stream << "Fatal"; break;
	default: stream << static_cast<int>(sev);
	}
