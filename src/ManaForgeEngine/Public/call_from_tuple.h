namespace detail
{
template <int numLeft, typename... TupleArgs> struct call_with_tuple_impl
{
...
template <typename... TupleArgs> struct call_with_tuple_impl<0, TupleArgs...>
{
	template <typename Fun, typename... Args>
	static auto apply(Fun&& fun, std::tuple<TupleArgs...>& tup, Args&&... args)
	{
...
template <typename Fun, typename... Args> auto callWithTuple(Fun&& fun, std::tuple<Args...>& args)
{
